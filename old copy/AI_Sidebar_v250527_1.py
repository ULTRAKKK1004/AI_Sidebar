...
class ClipboardItemWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.hide_button.setToolTip("Hide item")
        self.hide_button.clicked.connect(self.hide_item)
    ...
    def hide_item(self):
        # 임시로 숨기기 (실제로는 목록에서 제거)
        if hasattr(self.parent_widget, 'hide_clipboard_item'):
            self.parent_widget.hide_clipboard_item(self.index)

# --- Enhanced Assistant Widget with Markdown and Code Block Support ---
    ...
    def add_copy_buttons_to_code_blocks(self, html):
        ...
        def add_copy_button(match):
            ...
            button_html = (
                ...
                'style="position: absolute; top: 5px; right: 5px; background: #007bff; color: white; '
...
class ClipboardItem:
    def __init__(self, data_type, data, timestamp=None):
        ...
        self.pinned = False  # 고정 상태 추가

    def to_dict(self):
        data_dict = {"type": self.data_type, "timestamp": self.timestamp, "pinned": self.pinned}
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        layout.addWidget(self.clipboard_draggable)
        ...
        layout.addWidget(self.process_draggable)
